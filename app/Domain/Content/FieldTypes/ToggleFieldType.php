...
class ToggleFieldType extends BaseFieldType
{
    ...
    public static function getHandle(): string { return 'toggle'; }
    public static function getVueComponent(): string { return 'ToggleField'; }

    public static function getDefaultConfig(): array
    {
        return match('toggle') {
            'text' => ['input_type' => 'toggle', 'character_limit' => null, 'placeholder' => ''],
