...
class FloatFieldType extends BaseFieldType
{
    ...
    public static function getHandle(): string { return 'float'; }
    public static function getVueComponent(): string { return 'FloatField'; }

    public static function getDefaultConfig(): array
    {
        return match('float') {
            'text' => ['input_type' => 'number', 'character_limit' => null, 'placeholder' => ''],
