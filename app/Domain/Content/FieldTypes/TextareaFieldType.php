...
class TextareaFieldType extends BaseFieldType
{
    ...
    public static function getHandle(): string { return 'textarea'; }
    public static function getVueComponent(): string { return 'TextareaField'; }

    public static function getDefaultConfig(): array
    {
        return match('textarea') {
            'text' => ['input_type' => 'textarea', 'character_limit' => null, 'placeholder' => ''],
