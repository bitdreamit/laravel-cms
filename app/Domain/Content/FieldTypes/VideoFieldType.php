...
class VideoFieldType extends BaseFieldType
{
    ...
    public static function getHandle(): string { return 'video'; }
    public static function getVueComponent(): string { return 'VideoField'; }

    public static function getDefaultConfig(): array
    {
        return match('video') {
            'text' => ['input_type' => 'video', 'character_limit' => null, 'placeholder' => ''],
