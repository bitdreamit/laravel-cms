...
class TemplateFieldType extends BaseFieldType
{
    ...
    public static function getHandle(): string { return 'template'; }
    public static function getVueComponent(): string { return 'TemplateField'; }

    public static function getDefaultConfig(): array
    {
        return match('template') {
            'text' => ['input_type' => 'template', 'character_limit' => null, 'placeholder' => ''],
