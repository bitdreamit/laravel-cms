...
class SlugFieldType extends BaseFieldType
{
    ...
    public static function getHandle(): string { return 'slug'; }
    public static function getVueComponent(): string { return 'SlugField'; }

    public static function getDefaultConfig(): array
    {
        return match('slug') {
            'text' => ['input_type' => 'slug', 'character_limit' => null, 'placeholder' => ''],
