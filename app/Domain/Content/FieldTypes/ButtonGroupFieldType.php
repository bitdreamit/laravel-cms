...
class ButtonGroupFieldType extends BaseFieldType
{
    ...
    public static function getHandle(): string { return 'button_group'; }
    public static function getVueComponent(): string { return 'ButtonGroupField'; }

    public static function getDefaultConfig(): array
    {
        return match('button_group') {
            'text' => ['input_type' => 'button-group', 'character_limit' => null, 'placeholder' => ''],
