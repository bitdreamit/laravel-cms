...
class LinkFieldType extends BaseFieldType
{
    ...
    public static function getHandle(): string { return 'link'; }
    public static function getVueComponent(): string { return 'LinkField'; }

    public static function getDefaultConfig(): array
    {
        return match('link') {
            'text' => ['input_type' => 'link', 'character_limit' => null, 'placeholder' => ''],
