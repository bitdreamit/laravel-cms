...
class DateFieldType extends BaseFieldType
{
    ...
    public static function getHandle(): string { return 'date'; }
    public static function getVueComponent(): string { return 'DateField'; }

    public static function getDefaultConfig(): array
    {
        return match('date') {
            'text' => ['input_type' => 'date', 'character_limit' => null, 'placeholder' => ''],
