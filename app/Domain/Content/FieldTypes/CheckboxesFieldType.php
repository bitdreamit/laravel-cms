...
class CheckboxesFieldType extends BaseFieldType
{
    ...
    public static function getHandle(): string { return 'checkboxes'; }
    public static function getVueComponent(): string { return 'CheckboxesField'; }

    public static function getDefaultConfig(): array
    {
        return match('checkboxes') {
            'text' => ['input_type' => 'checkboxes', 'character_limit' => null, 'placeholder' => ''],
