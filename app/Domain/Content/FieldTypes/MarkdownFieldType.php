...
class MarkdownFieldType extends BaseFieldType
{
    ...
    public static function getHandle(): string { return 'markdown'; }
    public static function getVueComponent(): string { return 'MarkdownField'; }

    public static function getDefaultConfig(): array
    {
        return match('markdown') {
            'text' => ['input_type' => 'markdown', 'character_limit' => null, 'placeholder' => ''],
