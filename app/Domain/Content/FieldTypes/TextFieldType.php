...
class TextFieldType extends BaseFieldType
{
    ...
    public static function getHandle(): string { return 'text'; }
    public static function getVueComponent(): string { return 'TextField'; }

    public static function getDefaultConfig(): array
    {
        return match('text') {
            'text' => ['input_type' => 'text', 'character_limit' => null, 'placeholder' => ''],
