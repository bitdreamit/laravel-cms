...
class CodeFieldType extends BaseFieldType
{
    ...
    public static function getHandle(): string { return 'code'; }
    public static function getVueComponent(): string { return 'CodeField'; }

    public static function getDefaultConfig(): array
    {
        return match('code') {
            'text' => ['input_type' => 'code', 'character_limit' => null, 'placeholder' => ''],
