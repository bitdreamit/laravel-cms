...
class RadioFieldType extends BaseFieldType
{
    ...
    public static function getHandle(): string { return 'radio'; }
    public static function getVueComponent(): string { return 'RadioField'; }

    public static function getDefaultConfig(): array
    {
        return match('radio') {
            'text' => ['input_type' => 'radio', 'character_limit' => null, 'placeholder' => ''],
