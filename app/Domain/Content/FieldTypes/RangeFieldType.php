...
class RangeFieldType extends BaseFieldType
{
    ...
    public static function getHandle(): string { return 'range'; }
    public static function getVueComponent(): string { return 'RangeField'; }

    public static function getDefaultConfig(): array
    {
        return match('range') {
            'text' => ['input_type' => 'range', 'character_limit' => null, 'placeholder' => ''],
