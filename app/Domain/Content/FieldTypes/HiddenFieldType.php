...
class HiddenFieldType extends BaseFieldType
{
    ...
    public static function getHandle(): string { return 'hidden'; }
    public static function getVueComponent(): string { return 'HiddenField'; }

    public static function getDefaultConfig(): array
    {
        return match('hidden') {
            'text' => ['input_type' => 'hidden', 'character_limit' => null, 'placeholder' => ''],
