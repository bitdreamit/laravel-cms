...
class SectionFieldType extends BaseFieldType
{
    ...
    public static function getHandle(): string { return 'section'; }
    public static function getVueComponent(): string { return 'SectionField'; }

    public static function getDefaultConfig(): array
    {
        return match('section') {
            'text' => ['input_type' => 'section', 'character_limit' => null, 'placeholder' => ''],
