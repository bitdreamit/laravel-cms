...
class ColorFieldType extends BaseFieldType
{
    ...
    public static function getHandle(): string { return 'color'; }
    public static function getVueComponent(): string { return 'ColorField'; }

    public static function getDefaultConfig(): array
    {
        return match('color') {
            'text' => ['input_type' => 'color', 'character_limit' => null, 'placeholder' => ''],
