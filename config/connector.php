...
return [
    'cms_base_url' => env('CMS_BASE_URL', 'http://cms.example.com'),
    ...
    'auth_bridge' => [
        ...
        'shared_secret' => env('CMS_AUTH_BRIDGE_SECRET'),
        'cms_sso_url' => env('CMS_SSO_URL'),
        'token_ttl_seconds' => 60,
        'auto_create_users' => true,
        'default_role' => 'editor',
        'user_model' => env('CMS_USER_MODEL', \App\Models\Central\User::class),
        'sign_out_together' => false,
    ],

    'model_sync' => [
        'enabled' => env('CMS_MODEL_SYNC_ENABLED', false),
        'direction' => env('CMS_SYNC_DIRECTION', 'bidirectional'),
        'syncable_models' => [],
        'conflict_resolution' => env('CMS_CONFLICT_RESOLUTION', 'newest_wins'),
        'queue' => 'cms-sync',
        'retry_attempts' => 3,
        'batch_size' => 50,
    ],
